...
} from '../schemas/ship_behaviors';
import {
    SHIP_BEHAVIOR_PRESET_ID,
    type ShipBehaviorPresetId,
    type ShipBehaviorState,
...
const SHIP_BEHAVIOR_TUNING =
    SHIP_BEHAVIOR_TUNING_SCHEMA.parse(
        shipBehaviorTuningData,
    );
