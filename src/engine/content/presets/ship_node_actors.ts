...
import { SHIP_BEHAVIOR_PRESET_ID, type ShipBehaviorPresetId } from "./ship_behaviors";
import { SHIP_CREW_PRESET_ID, type ShipCrewPresetId } from "./ship_crews";
import { SHIP_PRESET_ID, type ShipPresetId } from "./ships";
...
export type ShipNodeActorPreset = {
    ...
    behaviorPresetId: ShipBehaviorPresetId;
};
...
export const SHIP_NODE_ACTOR_PRESETS = {
    ...
    [SHIP_NODE_ACTOR_PRESET_ID.ENEMY_GENERIC_BEAM_CANNON_00]: {
        id: SHIP_NODE_ACTOR_PRESET_ID.ENEMY_GENERIC_BEAM_CANNON_00,

        team: ENCOUNTER_TEAM.ENEMY,

        shipPresetId: SHIP_PRESET_ID.GENERIC_BEAM_CANNON_00,
    ...
    [SHIP_NODE_ACTOR_PRESET_ID.ENEMY_COMBAT_00]: {
        id: SHIP_NODE_ACTOR_PRESET_ID.ENEMY_COMBAT_00,
