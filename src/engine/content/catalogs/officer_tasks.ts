...
const SCIENCE_OFFICER_TASK_TUNING = SCIENCE_OFFICER_TASK_TUNING_SCHEMA.parse(scienceOfficerTaskTuningData);

const WEAPONS_OFFICER_TASK_TUNING = WEAPONS_OFFICER_TASK_TUNING_SCHEMA.parse(weaponsOfficerTaskTuningData);

const HELM_OFFICER_TASK_TUNING = HELM_OFFICER_TASK_TUNING_SCHEMA.parse(helmOfficerTaskTuningData);
