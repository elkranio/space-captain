...
export const SCIENCE_OFFICER_TASK_TUNING_SCHEMA = z.strictObject({
    [OFFICER_TASK_KIND.SCIENCE_PLOT_COURSE]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.SCIENCE_PLOT_COURSE],

    [OFFICER_TASK_KIND.SCIENCE_PURGE_SPAM]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.SCIENCE_PURGE_SPAM],

    [OFFICER_TASK_KIND.SCIENCE_FIRE_SPAM]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.SCIENCE_FIRE_SPAM],
});

export const WEAPONS_OFFICER_TASK_TUNING_SCHEMA = z.strictObject({
    [OFFICER_TASK_KIND.WEAPONS_DEFENSE_TURRET]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.WEAPONS_DEFENSE_TURRET],

    [OFFICER_TASK_KIND.WEAPONS_FIRE_MISSILE]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.WEAPONS_FIRE_MISSILE],

    [OFFICER_TASK_KIND.WEAPONS_FIRE_STICKY_MINES]:
        OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.WEAPONS_FIRE_STICKY_MINES],

    [OFFICER_TASK_KIND.WEAPONS_FIRE_BEAM_CANNON]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.WEAPONS_FIRE_BEAM_CANNON],
});

export const HELM_OFFICER_TASK_TUNING_SCHEMA = z.strictObject({
    [OFFICER_TASK_KIND.HELM_DOCK]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.HELM_DOCK],

    [OFFICER_TASK_KIND.HELM_FLY_TO]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.HELM_FLY_TO],

    [OFFICER_TASK_KIND.HELM_JUMP]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.HELM_JUMP],

    [OFFICER_TASK_KIND.HELM_EVADE]: OFFICER_TASK_TUNING_SHAPE[OFFICER_TASK_KIND.HELM_EVADE],
});
