...
import { SHIP_BEHAVIOR_PRESET_ID } from "../../defs/ship_behavior";
...
export const SHIP_BEHAVIOR_TUNING_SCHEMA = z.strictObject({
    [SHIP_BEHAVIOR_PRESET_ID.STANDARD_COMBAT_00]: z
        .strictObject({
            decisionTickDurationMs: z
                .number()
                .int()
                .nonnegative()
                .meta({
                    title: "Captain decision tick",
            ...
            decisionTickWiggleMs: z
                .number()
                .int()
                .nonnegative()
                .meta({
                    title: "Decision tick wiggle",
            ...
            threatTimingWiggleMs: z
                .number()
                .int()
                .nonnegative()
                .meta({
                    title: "Threat timing wiggle",
        ...
        .meta({
            title: "Standard Combat",
        }),
});

export type ShipBehaviorTuningData = z.infer<typeof SHIP_BEHAVIOR_TUNING_SCHEMA>;
