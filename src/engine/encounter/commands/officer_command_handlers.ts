...
import { weaponsInterceptMissileCommandHandler } from "./handlers/weapons_defense_turret_command_handler";
import { weaponsFireMissileCommandHandler } from "./handlers/weapons_fire_missile_command_handler";
import { weaponsFireStickyMinesCommandHandler } from "./handlers/weapons_fire_sticky_mines_command_handler";
import { weaponsFireBeamCannonCommandHandler } from "./handlers/weapons_fire_beam_cannon_command_handler";
...
const OFFICER_COMMAND_HANDLER_BY_ID = {
    ...
    [ENCOUNTER_OFFICER_COMMAND_ID.SCIENCE_FIRE_SPAM]: scienceFireSpamCommandHandler,
    ...
    [ENCOUNTER_OFFICER_COMMAND_ID.WEAPONS_INTERCEPT_MISSILE]: weaponsInterceptMissileCommandHandler,

    [ENCOUNTER_OFFICER_COMMAND_ID.WEAPONS_FIRE_MISSILE]: weaponsFireMissileCommandHandler,

    [ENCOUNTER_OFFICER_COMMAND_ID.WEAPONS_FIRE_STICKY_MINES]: weaponsFireStickyMinesCommandHandler,

    [ENCOUNTER_OFFICER_COMMAND_ID.WEAPONS_FIRE_BEAM_CANNON]: weaponsFireBeamCannonCommandHandler,
