...
export default class EnemyThreatObserver {
    ...
    private synchronizeActor(
        ...
        actor.threatObservations.splice(
            0,
            actor.threatObservations.length,
            ...next,
        );
    }

    private collectCurrentObservations(
        actorId: string,
