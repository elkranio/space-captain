...
export function getActiveCrewProgressEffects(
    state: EncounterState,
): CrewProgressEffect[] {
    const effects:
        CrewProgressEffect[] = [];

    appendEnemySpamEffects(
        state,
        effects,
    );

    appendPlayerSpamEffect(
        state,
        effects,
    );
...
function appendEnemySpamEffects(
    state: EncounterState,
    effects: CrewProgressEffect[],
): void {
...
function appendPlayerSpamEffect(
    state: EncounterState,
    effects: CrewProgressEffect[],
): void {
    const task =
...
function getSpamProgressMultiplier(
