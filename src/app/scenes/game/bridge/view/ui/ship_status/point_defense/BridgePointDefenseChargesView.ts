// src/app/scenes/game/bridge/view/ui/ship_status/point_defense/BridgePointDefenseChargesView.ts

import { FONT_COLOR, FONT_FAMILY, FONT_SIZE } from '../../../../../../../theme/font';
import type BridgeScene from '../../../../BridgeScene';

// Отображает только запас
// point-defense charges.
//
// Не знает:
// - откуда пришли данные;
// - как расходуются charges;
// - как устроена общая status panel.
export default class BridgePointDefenseChargesView {
    ...
    public setState(current: number, max: number): void {
        this.label.setText(`PD  ${current}/${max}`);
    }
