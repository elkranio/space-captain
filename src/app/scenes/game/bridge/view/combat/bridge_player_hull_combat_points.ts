...
const VIEWSCREEN_CENTER_X = Math.round(BRIDGE_VIEWSCREEN_RECT.x + BRIDGE_VIEWSCREEN_RECT.width / 2);
...
export const BRIDGE_PLAYER_HULL_COMBAT_POINTS = {
    ...
    shieldAnchor: {
        x: VIEWSCREEN_CENTER_X,

        y: VIEWSCREEN_BOTTOM_Y + 22,
    },

    // Отдельная видимая точка блокировки:
    // чуть выше и левее hull impact, внутри center shield.
    shieldImpactPoint: {
        x: VIEWSCREEN_CENTER_X - 55,

        y: VIEWSCREEN_BOTTOM_Y - 58,
    },
