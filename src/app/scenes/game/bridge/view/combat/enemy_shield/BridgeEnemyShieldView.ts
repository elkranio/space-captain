...
export default class BridgeEnemyShieldView {
    ...
    constructor(
        ...
        private readonly getActorPosition:
            GetActorPosition,
    ) {
        this.eventBus.on(
            BRIDGE_EVENT
