...
import {
    SHIP_EVADE_PHASE,
    type ShipEvadePhase,
} from '../../../../../../../engine/defs/ship_evade';
import type BridgeScene from '../../../BridgeScene';
import {
    BRIDGE_EVENT,
    type BridgePlayerEvadeUpdatedPayload,
...
import {
    BRIDGE_PLAYER_EVADE_PRESENTATION,
} from './bridge_player_evade_presentation';
...
export default class BridgePlayerEvadeView {
    ...
    private returnFadeActive =
        false;

    private returnFadeElapsedMs =
        0;

    private returnStartDustAlpha =
        0;

    private shakePulseElapsedMs =
        0;
    ...
    private handleEvadeUpdated(
        ...
        if (
            ...
            this.beginDustReturnFade(
                this.getEvadingDustAlpha(
                    this.phaseElapsedMs,
                ),
            );
        } else if (
    ...
    private beginManeuverPresentation():
        void {
        this.dustDirection =
            Math.random() < 0.5
                ? -1
        ...
        this.returnFadeActive =
            false;

        this.returnFadeElapsedMs =
            0;
