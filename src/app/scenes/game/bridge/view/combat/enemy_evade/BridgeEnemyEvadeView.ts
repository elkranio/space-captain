...
import {
    BRIDGE_EVENT,
    type BridgeEnemyEvadesUpdatedPayload,
} from '../../../events/bridge_event';
import type BridgeEventBus from '../../../events/BridgeEventBus';
import {
    BRIDGE_ENEMY_EVADE_PRESENTATION,
} from './bridge_enemy_evade_presentation';
...
type SetObjectPresentationOffsetX = (
    objectId: string,
    offsetX: number,
) => boolean;
...
export default class BridgeEnemyEvadeView {
    ...
    constructor(
        ...
        private readonly setObjectPresentationOffsetX:
    ...
    public destroy(): void {
        ...
        for (
            ...
            this.setObjectPresentationOffsetX(
                state.actorId,
                0,
            );
        }
    ...
    private handleEvadesUpdated(
        ...
        for (
            ...
            if (
                ...
                state.activeStartOffsetX =
                    state.accumulatedOffsetX;
