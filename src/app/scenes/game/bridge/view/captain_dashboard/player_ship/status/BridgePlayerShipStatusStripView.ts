...
export default class BridgePlayerShipStatusStripView {
    ...
    private readonly powerText:
        Phaser.GameObjects.BitmapText;

    private readonly engineText:
        Phaser.GameObjects.BitmapText;

    private readonly evadeButton:
        Phaser.GameObjects.Rectangle;

    private readonly evadeLabel:
        Phaser.GameObjects.BitmapText;

    private readonly powerTrack:
        Phaser.GameObjects.Rectangle;

    private readonly powerFill:
        Phaser.GameObjects.Rectangle;

    private readonly powerBarWidth:
        number;

    private evadeActionHandler?:
        () => void;
    ...
    constructor(
        ...
        this.applyEvadeActionVisualState(
            BRIDGE_PLAYER_SYSTEM_ACTION_STATE
                .DISABLED_SYSTEM,
        );
    ...
    private handleDashboardUpdated(
        ...
        this.setEvadeAction(
            status.evadeAction.state,
            status.evadeAction.command,
        );
    ...
    private setEvadeAction(
        ...
        if (
            ...
            throw new Error(
                'Active EVADE dashboard action requires command',
            );
        }
    ...
    private handleEvadePointerDown():
        void {
        this.evadeActionHandler?.();
    }

    private applyEvadeActionVisualState(
        state:
            BridgePlayerSystemActionState,
    ): void {
        this.evadeButton
