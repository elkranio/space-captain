...
// Контекст для handlers, которые переводят EncounterEngine events
// в bridge scene events.
//
// Handlers не знают про BridgeEncounterController напрямую:
// только эмитят события, меняют interactivity
// и вызывают разрешённые encounter lifecycle operations.
