// tests/fixtures/engine/missile_enemy_fixtures.ts
...
const MISSILE_ENEMY_SHIP_PRESET: ShipPreset = {
    id: 'test_missile_enemy',
...
export function createMissileEnemyActorFixture(
    anchorId: string,
    id = 'ship_enemy_00',
): ShipSpaceNodeActorState {
