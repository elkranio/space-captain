// tests/fixtures/engine/sticky_mine_enemy_fixtures.ts
...
const STICKY_MINE_ENEMY_SHIP_PRESET: ShipPreset = {
    id: 'test_sticky_mine_enemy',
...
export function createStickyMineEnemyActorFixture(
    anchorId: string,
): ShipSpaceNodeActorState {
